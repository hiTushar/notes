...
import { Card, ToggleButton, ToggleButtonGroup, Row, Col } from 'react-bootstrap';
                ...
                <Col>
                    <Card style={{ width: '500px' }}>
                        <Card.Body>
                            ...
                            <Card.Text>
                                <ToggleButtonGroup type='radio' name='theme-setting' defaultValue={theme} onChange={changeTheme}>
                                    <ToggleButton id='light' value='light'>Light</ToggleButton>
                                    <ToggleButton id='dark' value='dark'>Dark</ToggleButton>
                                </ToggleButtonGroup>
                            </Card.Text>
                        </Card.Body>
                    </Card>
